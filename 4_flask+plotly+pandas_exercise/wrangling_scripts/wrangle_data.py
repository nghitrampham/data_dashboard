...
# fourth chart shows rural population vs arable land
    ...
    # Make a fifth chart from the data in API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv
    ...
    layout_five = dict(title = 'Total rural population for various countries in 2015',
                xaxis = dict(title = 'Country',),
